    ...
    <footer className="bg-gray-900 text-white pt-16 pb-8">
      <Container>
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-8 pb-8">
          <div>
            <h3 className="text-xl font-serif font-bold text-indigo-400 mb-4">
              {siteConfig.name}
            </h3>
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-start space-x-3">
                <MapPin className="text-indigo-400 w-5 h-5 mt-0.5" />
              ...
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-300">connect@afterlife.org</span>
              </div>
            </div>
          </div>
        </div>
